...
<?php echo $this->Form->create('BusinessReview'); ?>
	<fieldset>
		<legend><?php echo __('Edit Business Review'); ?></legend>
	<?php
...
<div class="actions">
	...
	<ul>
		...
		<li><?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $this->Form->value('BusinessReview.id')), array(), __('Are you sure you want to delete # %s?', $this->Form->value('BusinessReview.id'))); ?></li>
